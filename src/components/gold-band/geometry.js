...
const A = {
  ...
  outRail: { off: 20, w: 3.5, color: '#fce18c' },
  outHair: { off: 22, w: 0.9, color: '#fff6d8', opacity: 0.55 },
  inRail:  { off: -20, w: 3.0, color: '#c9a85a', opacity: 0.85 },
  genFrom: -127, genTo: 0,
  enter: [600, 900], exit: [0, 640],
  slotCount: 10,
  runeScale: 0.30,                  // 略小于通道宽（40-2=38），符文在两条线之间
...
const M = {
  ...
  inRail:  { off: -17, w: 2.5, color: '#c9a85a', opacity: 0.85 },
  genFrom: -130, genTo: 0,
