// 《上古道家隐传秘传体系认知》B 站合集数据
// 来源：https://space.bilibili.com/471124175/lists/4453923?type=season （UP：巫-鸿）
...
export const groups: VideoGroup[] = [
  ...
  },
  {
    ...
    videos: [
      ...
      { bvid: 'BV1XqBDYPEro', title: '二.4 历来学艺者的付费行为', raw: '二.4道家基础认知历来学艺者的付费行为（仅供娱乐，无不良引导）', date: '2024-11-26', secs: 447 },
      { bvid: 'BV1vxBZYREJG', title: '二.5 修道有所成者的身份总结', raw: '二.5:道家基础认知，古往今来修道有所成者的身份总结（仅供娱乐，无不良引导）', date: '2024-11-27', secs: 52 },
      { bvid: 'BV1opBZYoEsw', title: '二.6 现代人修道能走的路', raw: '二.6:道家基础认知，现代人修道能走的路（仅供娱乐，无不良引导）', date: '2024-11-28', secs: 140 },
      { bvid: 'BV1vvziYAEiG', title: '二.7 修道几小问', raw: '二.7:道家基础认知修道几小问（仅供娱乐，无不良引导）', date: '2024-11-29', secs: 52 },
    ],
  },
  {
    tag: '三',
    ...
    videos: [
      { bvid: 'BV14z6wYxEbZ', title: '三.1 道家传承的传播方式', raw: '第三课，道家基础认知三.1:道家传承的传播方式（仅供娱乐，无不良引导）', date: '2024-12-02', secs: 137 },
      { bvid: 'BV1LK6NY1Ev3', title: '三.2 道家完成的传承', raw: '道家基础认知 三.2道家完成的传承（仅供娱乐，无不良引导）', date: '2024-12-02', secs: 461 },
      ...
      { bvid: 'BV1CUzXYtEgN', title: '三.4.1 存思', raw: '道家基础认知三.4.1:古往今来的道法体系之——存思（无不良引导，仅供娱乐）', date: '2024-12-03', secs: 41 },
      { bvid: 'BV1KyzXYwEJq', title: '三.4.2 存神', raw: '道家基础认知三.4.2:古往今来的道法体系之——存神（仅供娱乐，无不良引导）', date: '2024-12-04', secs: 20 },
      { bvid: 'BV1C2zXYfEQC', title: '三.4.3 精思', raw: '道家基础认知三.4.3:古往今来的道法体系之——精思（无不良引导，仅供娱乐）', date: '2024-12-04', secs: 20 },
      { bvid: 'BV1fjzXYJEVn', title: '三.4.4 导引', raw: '道家基础认知三.4.4:古往今来的道法体系之——导引（仅供娱乐，无不良引导）', date: '2024-12-04', secs: 120 },
      { bvid: 'BV12ViQYQEsE', title: '三.4.5 服食', raw: '道家基础认知三.4.5:古往今来的道法体系之——服食（仅供娱乐，无不良引导）', date: '2024-12-04', secs: 397 },
      { bvid: 'BV1QAiQYbE8F', title: '三.4.6 服食 · 续', raw: '道家基础认知三.4.6:古往今来的道法体系之——服食仅供娱乐，无不良引导）', date: '2024-12-04', secs: 310 },
      { bvid: 'BV1CHiQYjEEK', title: '三.4.7 内丹', raw: '道家基础认知三.4.7:古往今来的道法体系之——内丹（仅供娱乐，无不良引导）', date: '2024-12-04', secs: 100 },
